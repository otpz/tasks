...
import AtRule, { AtRuleProps } from 'postcss/lib/at-rule.jsat-rule.js'
import Comment, { CommentProps } from 'postcss/lib/comment.jscomment.js'
import Container, { ContainerProps } from 'postcss/lib/container.jsntainer.js'
import CssSyntaxError from 'postcss/lib/css-syntax-error.jsx-error.js'
import Declaration, { DeclarationProps } from 'postcss/lib/declaration.jsaration.js'
import Document, { DocumentProps } from 'postcss/lib/document.jsocument.js'
import Input, { FilePosition } from 'postcss/lib/input.jsb/input.js'
import LazyResult from 'postcss/lib/lazy-result.js-result.js'
import list from 'postcss/lib/list.jsib/list.js'
import Node, {
  AnyNode,
  ChildNode,
  ChildProps,
  ...
  Position,
  Source
} from 'postcss/lib/node.jsib/node.js'
import Processor from 'postcss/lib/processor.jsocessor.js'
import Result, { Message } from 'postcss/lib/result.js/result.js'
import Root, { RootProps } from 'postcss/lib/root.jsib/root.js'
import Rule, { RuleProps } from 'postcss/lib/rule.jsib/rule.js'
import Warning, { WarningOptions } from 'postcss/lib/warning.jswarning.js'
